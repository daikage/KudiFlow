...
@section('content')
  <div class="flex items-center justify-between mb-4">
    ...
    <a href="#" class="px-4 py-2 rounded-xl bg-primary text-on-primary shadow-sm">New Plan</a>
  </div>
        ...
        <tbody>
          <tr class="border-t border-outline-variant/10">
            ...
            <td class="px-4 py-3 text-right">
              <a href="#" class="px-3 py-1 rounded-lg bg-white border border-outline-variant/30 text-on-surface-variant">View</a>
            </td>
          </tr>
          <tr>
            <td colspan="5" class="px-4 py-6 text-center text-on-surface-variant">Connect billing provider to load subscriptions.</td>
          </tr>
        </tbody>
      </table>
    </div>
