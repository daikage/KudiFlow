  ...
  <div class="bg-surface-container-lowest rounded-xl p-6 shadow-sm border border-outline-variant/5">
    ...
    <form action="#" method="POST" class="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      <div class="md:col-span-2">
        ...
        <input class="w-full bg-surface-container-low border border-outline-variant/30 rounded-lg px-3 py-2" placeholder="e.g. Diesel">
      </div>
      <div>
      ...
      <div class="md:col-span-3 flex gap-2">
        <a href="/ui/expenses" class="px-4 py-2 rounded-lg bg-white border border-outline-variant/30 text-on-surface-variant hover:bg-surface-variant/30">Cancel</a>
